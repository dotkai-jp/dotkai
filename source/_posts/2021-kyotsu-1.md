...
特に今年の倫政は，正直第1問問1が一番難しかったと思います。（暗記問題ですが）
...
政経も同じく，1番最初の問題が結構難しかった覚えがあります。第5問問1です。**とにかく問題が長い**。**すぐに答えが出ないので，本番は特に焦ります。**自分に落ち着け，と言い聞かせて何とか乗り切りました。ここは正解。
...
第6問問4，間違えてしまいました。これが一番難しかったのではないでしょうか。プレテストにもこのような読み取り問題はありましたが，**やはり本番はあまり頭が回りません**。③を選びましたが，「預金に対する」は確かに変ですね。こういうところで落とすのは国語と同じです。アンテナがちょっと足りなかったです。
...
ここからは普段に近い感じで解けました。古文は問3のみ落としました。「」で気持ちなどを囲むと良いですが，どこまでが「」の中なのか，の判断を誤ったようです。
...
第5問まではいつもの感じで出来ました。ただ，迷ったら間違える。
